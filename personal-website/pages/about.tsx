        ...
        <>
          ...
          >
            ...
            >
              ...
              {/* Contact Form */}
              <form onSubmit={handleSubmit} style={{ width: '100%' }}> {/* Set width to 100% */}
                <div className="mb-4" style={{ width: '100%' }}>
                  ...
                  <input
                    ...
                    style={{ width: '100%', fontSize: '1.2rem', padding: '20px', color: "black", }} // Increased padding
                    required
                    value={formData.name}
                ...
                <div className="mb-4" style={{ width: '100%' }}>
                  <label htmlFor="message" className="form-label" style={{ fontSize: '1.5rem' }}>
                    Message
                  </label>
                  <textarea
                    id="message"
                    ...
                    rows={6}
                    className="form-input"
                    style={{ width: '100%', fontSize: '1.2rem', padding: '20px', textColor: "black", }} // Increased padding
                    required
                ...
                <button
                  ...
                  style={{ marginTop: "10px", fontSize: '1.2rem', padding: '10px 20px' }}
                >
                  Submit
                </button>
              </form>
